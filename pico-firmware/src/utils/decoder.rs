use super::mp3dec::{mp3dec_decode_frame, mp3dec_frame_info_t, mp3dec_init, mp3dec_t};
use core::{
    ffi::c_int,
    marker::PhantomData,
    mem::MaybeUninit,
...
#[inline(always)]
unsafe fn source_slice<'src, 'frame>(data: &'src [u8], frame_recv: &'frame mp3dec_frame_info_t) -> &'src [u8] { unsafe {

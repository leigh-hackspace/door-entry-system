...
use cyw43::{JoinOptions, Runner, SpiBus, aligned_bytes};
...
const WIFI_NETWORK: &str = "Leighhack"; // change to your network SSID
const WIFI_PASSWORD: &str = "caffeine1234"; // change to your network password
